...
./configure \
	...
	CPPFLAGS="$CPPFLAGS" \
	CFLAGS="$DEBUG_CFLAGS -Wall -Wextra -Werror -Wno-clobbered -Wno-deprecated-declarations $CFLAGS" \
	CXXFLAGS="$DEBUG_CXXFLAGS -Wall -Wextra -Werror -Wno-clobbered -Wno-deprecated-declarations $CXXFLAGS" \
	LDFLAGS="$LDFLAGS" \
